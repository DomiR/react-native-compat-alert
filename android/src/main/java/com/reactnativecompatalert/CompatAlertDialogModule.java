...
package com.reactnativecompatalert;
...
@ReactModule(name = CompatAlertDialogModule.NAME)
public class CompatAlertDialogModule extends ReactContextBaseJavaModule implements  LifecycleEventListener {

  /* package */ static final String FRAGMENT_TAG =
      "com.facebook.catalyst.react.dialog.CompatDialogModule";

  public static final String NAME = "CompatAlertDialogManagerAndroid";
  ...
  public CompatAlertDialogModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  public void onHostResume() {
    ...
    if (fragmentManagerHelper != null) {
      ...
      FLog.w(CompatAlertDialogModule.class, "onHostResume called but no FragmentManager found");
    }
  }
