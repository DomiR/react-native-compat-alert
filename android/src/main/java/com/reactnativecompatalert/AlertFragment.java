...
public class AlertFragment extends DialogFragment implements DialogInterface.OnClickListener {
  ...
  private final @Nullable CompatAlertDialogModule.AlertFragmentListener mListener;
  ...
  public AlertFragment(@Nullable CompatAlertDialogModule.AlertFragmentListener listener, Bundle arguments) {
    mListener = listener;
